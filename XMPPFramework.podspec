Pod::Spec.new do |s|
  ...
  s.source = { :git => 'https://github.com/IOOI-SqAR/XMPPFramework.git', :tag => s.version }
  # s.source = { :git => 'https://github.com/IOOI-SqAR/XMPPFramework.git', :branch => 'master' }
